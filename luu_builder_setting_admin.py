...
def admin_write_menubuilder(domain_name):
    ...
    commond.drag_drop_Element(data["menubuilder"]["single_line_from"],data["menubuilder"]["editor_to_drag"])
    Logging("7.Drag Layout Single Line  successfully")
    time.sleep(1)
    commond.drag_drop_Element(data["menubuilder"]["email_from"],data["menubuilder"]["editor_to_drag_2"])
    Logging("8.Drag Layout Email  successfully")
    time.sleep(1)
    commond.drag_drop_Element(data["menubuilder"]["url_from_builder"],data["menubuilder"]["editor_to_drag"])
    Logging("9.Drag Layout URL  successfully")
    time.sleep(1)
    commond.drag_drop_Element(data["menubuilder"]["date_from_builder"],data["menubuilder"]["editor_to_drag_2"])
    Logging("10.Drag Layout Date  successfully")
    time.sleep(1)
    commond.drag_drop_Element(data["menubuilder"]["datetime_from_builder"],data["menubuilder"]["editor_to_drag"])
    Logging("11.Drag Layout Date/Time  successfully")
    time.sleep(1)
    commond.drag_drop_Element(data["menubuilder"]["daterange_from_builder"],data["menubuilder"]["editor_to_drag_2"])
    Logging("11.Drag Date Range  successfully")
    time.sleep(1)
    commond.drag_drop_Element(data["menubuilder"]["phone_from_builder"],data["menubuilder"]["editor_to_drag"])
    time.sleep(1)
    ...
    commond.drag_drop_Element(data["menubuilder"]["multi_line_from_builder"],data["menubuilder"]["editor_to_drag_2"])
    ...
    commond.drag_drop_Element(data["menubuilder"]["address_from_builder"],data["menubuilder"]["editor_to_drag"])
    time.sleep(1)
    ...
    commond.drag_drop_Element(data["menubuilder"]["number_from_builder"],data["menubuilder"]["editor_to_drag_2"])
    Logging("18.Drag Layout Number successfully")
    time.sleep(1)
    commond.drag_drop_Element(data["menubuilder"]["percent_from_builder"],data["menubuilder"]["editor_to_drag"])
    Logging("19.Drag Layout Percent successfully")
    time.sleep(1)

    commond.drag_drop_Element(data["menubuilder"]["multi_select_from_builder"],data["menubuilder"]["editor_to_drag_2"])
    time.sleep(1)
    ...
    time.sleep(1)
    commond.drag_drop_Element(data["menubuilder"]["pick_list_from_builder"],data["menubuilder"]["editor_to_drag"])
    time.sleep(1)
    ...
    time.sleep(1)
    commond.drag_drop_Element(data["menubuilder"]["attachfile_from_builder"],data["menubuilder"]["editor_to_drag"])
    Logging("23.Drag Layout Attach files successfully")
    time.sleep(1)
    commond.drag_drop_Element(data["menubuilder"]["comment_from_builder"],data["menubuilder"]["editor_to_drag"])
...
def write_layout_menubuilder(domain_name):
    ...
    commond.Wait10s_ClickElement(data["menubuilder"]["select_export"])
    Logging("2.Click Export successfully")
    commond.Wait10s_ClickElement(data["menubuilder"]["click_select_all"])
    Logging("3.Select All successfully")
    commond.Wait10s_ClickElement(data["menubuilder"]["btn_export"])
    ...
    commond.Wait10s_ClickElement(data["menubuilder"]["btn_mark_as_read"])
    time.sleep(1)
    ...
    commond.Wait10s_ClickElement(data["menubuilder"]["btn_download_all_file"])
    ...
    commond.Wait10s_ClickElement(data["menubuilder"]["select_title_download"])
    Logging("1.Select Title successfully")
    commond.Wait10s_ClickElement(data["menubuilder"]["icon_download_file_layout"])
    ...
    Logging("--------------------- Copy-Past  ---------------------")
    try:
        commond.Wait10s_ClickElement(data["menubuilder"]["btn_more_copy"])
        time.sleep(1)
        commond.Wait10s_ClickElement(data["menubuilder"]["value_copy_data"])
        time.sleep(1)
        commond.Wait10s_ClickElement(data["menubuilder"]["btn_close_copy_data"])
        time.sleep(1)
        ...
        Logging("1. Click Create successfully")
        time.sleep(1)
        commond.Wait10s_ClickElement(data["menubuilder"]["btn_paste_copy_data"])
        time.sleep(1)
        driver.refresh()
        time.sleep(8)
        '''
    ...
    commond.Wait10s_ClickElement(data["menubuilder"]["btn_timeline"])
    ...
    try:
        commond.Wait10s_ClickElement(data["menubuilder"]["icon_calendar_view"])  
        time.sleep(8)
        if 'Lunar' in driver.page_source :
            Logging(Green("Calendar View => ---------- PASS"))
        else:
            Logging(Red("Calendar View => ---------- FAIL"))
        commond.Wait10s_ClickElement(data["menubuilder"]["icon_list_view"])
        time.sleep(3)
    except WebDriverException:
...
def delete_menubuilder(domain_name):
    ...
    time.sleep(1)
    try:
        commond.Wait10s_ClickElement(data["menubuilder"]["click_btn_delete_menu"])
        time.sleep(1)
        Logging("8. Click icon Delete successfully")
        commond.Wait10s_ClickElement(data["menubuilder"]["check_force_delete"])
