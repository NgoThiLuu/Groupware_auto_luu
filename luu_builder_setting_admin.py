...
def admin_write_menubuilder(domain_name):
    ...
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_single_choice_options_2"],data["menubuilder"]["name_option2_single_choice"])
    time.sleep(1)
    Logging("16b.Input Option 2 Single Choice successfully")

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_single_choice_options_3"],data["menubuilder"]["name_option3_single_choice"])
    ...
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_multi_select_options_1"],data["menubuilder"]["name_option1_multi_select"])
    Logging("20a.Input Option 1 Multi-Select successfully")
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_multi_select_select_2"],data["menubuilder"]["name_option2_multi_select"])
    time.sleep(1)
    Logging("20b.Input Option 2 Multi-Select successfully")

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_multi_select_select_3"],data["menubuilder"]["name_option3_multi_select"])
    ...
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_pick_list_options_1"],data["menubuilder"]["name_option1_pick_list"])
    Logging("21a.Input Option 1 Pick List successfully")

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_pick_list_select_2"],data["menubuilder"]["name_option2_pick_list"])
    Logging("21b.Input Option 2 Pick List successfully")
    time.sleep(1)
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_pick_list_select_3"],data["menubuilder"]["name_option3_pick_list"])
    ...
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_edit_name_folder"],data["menubuilder"]["name_folder_edit"])
...
def write_layout_menubuilder(domain_name):
    ...
    commond.Wait10s_InputElement_return(data["menubuilder"]["click_pick_list"],data["menubuilder"]["name_search_pick_list"])
    ...
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_multi_select"],data["menubuilder"]["search_multi_select"])
    time.sleep(1)
    ...
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_create_date"],data["menubuilder"]["create_date_search"])
    Logging("3.Select Created Date successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_single_line"],data["menubuilder"]["single_line_search"])
    Logging("4.Select Single Line successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_email"],data["menubuilder"]["email_search"])
    Logging("5.Select Value Email successfully")
    time.sleep(1)
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_url"],data["menubuilder"]["url_search"])
    ...
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_date_time"],data["menubuilder"]["date_time_search"])
    Logging("8.Select Date Time successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_date_range"],data["menubuilder"]["date_range_search"])
    Logging("9.Select Date Range successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_phone"],data["menubuilder"]["phone_search"])
    Logging("10.Select Phone successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_multi_line"],data["menubuilder"]["multi_line_search"])
    Logging("11.Select Multi Line  successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_multiple_choice"],data["menubuilder"]["multiple_choice_search"])
    Logging("12.Select Multiple Choice successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_single_choice"],data["menubuilder"]["single_choice_search"])
    Logging("13.Select Single Choice successfully")
    time.sleep(1)


    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_address"],data["menubuilder"]["address_search"])
    Logging("14.Select Address successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_currency"],data["menubuilder"]["currency_search"])
    Logging("15.Select Currency successfully")


    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_number"],data["menubuilder"]["number_search"])
    Logging("16.Select Number successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_percent"],data["menubuilder"]["percent_search"])
    Logging("17.Select Percent successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_multi_select"],data["menubuilder"]["multi_select_search"])
    Logging("18.Select Multi Select successfully")
    time.sleep(1)

    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_value_pick_list"],data["menubuilder"]["pick_list_search"])
    ...
    commond.Wait10s_InputElement_return(data["menubuilder"]["txt_search_keyword_all"],data["menubuilder"]["name_search_all"])
