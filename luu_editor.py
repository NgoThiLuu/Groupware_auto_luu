...
def editor_table_task(domain_name):
    ...
    time.sleep(1)
    commond.Wait10s_InputElement(data["editor"]["content_column1_row1"],data["editor"]["name_content_column1_row1"])
    Logging("5. Input Content Column 1- Row 1 In Editor successfully")
    commond.Wait10s_ClickElement(data["editor"]["content_column2_row1"])
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["icon_txt_text_corlor"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["select_color_red"])
    Logging("5. Select Corlor => Pass")
    time.sleep(1)
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["bold_text"])
    Logging("Click Icon Bold => Pass")
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["italic_text"])
    time.sleep(1)
    Logging("Click Icon Italic => Pass")
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["underline_text"])
    time.sleep(1)
    ...
    commond.Wait10s_ClickElement(data["editor"]["list_select_border_style"])
    commond.Wait10s_ClickElement(data["editor"]["select_border_style_soild"])
    ...
    commond.Wait10s_ClickElement(data["editor"]["content_column3_row1"])
    driver.switch_to.default_content()
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["click_icon_align"])
    commond.Wait10s_ClickElement(data["editor"]["select_align_center"])
    ...
    commond.Wait10s_ClickElement(data["editor"]["content_column3_row2"])
    driver.switch_to.default_content()
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["icon_insearch_image_editor"])
    Logging("11. Click icon Insert  successfully")
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["insert_image_upload"])
    time.sleep(1)
    ...
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["btn_save_insert_image"])
    time.sleep(1)
    ...
    Logging("===========  Insert Link  ============ ")
    commond.Wait10s_ClickElement(data["editor"]["content_column4_row2"])
    driver.switch_to.default_content()
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["icon_link_edit"])
    Logging("10. Click Icon Link successfully")
    commond.Wait10s_InputElement(data["editor"]["txt_url_edit_table"],data["editor"]["name_url"])
    Logging("=> Input URL successfully")
    time.sleep(2)
    commond.Wait10s_InputElement(data["editor"]["txt_to_display"],data["editor"]["name_text_to_display"])
    Logging("=> Input URL successfully")
    commond.Wait10s_ClickElement(data["editor"]["btn_save_insert_link_table"])
    ...
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["click_table"])
    commond.Wait10s_ClickElement(data["editor"]["table_row"])
    ...
    commond.Wait10s_ClickElement(data["editor"]["row_properties"])
    Logging("4. Click Row properties successfully")
    commond.Wait10s_ClickElement(data["editor"]["table_properties_advanced"])
    Logging("5. Click tab Advanced Table Properties successfully")
    commond.Wait10s_ClickElement(data["editor"]["icon_background_color"])
    Logging("6. Click icon Background Color successfully")
    commond.Wait10s_ClickElement(data["editor"]["select_color_light_blue_background"])
    Logging("7. Select Corlor => Pass")
    commond.Wait10s_ClickElement(data["editor"]["list_select_border_style"])
    commond.Wait10s_ClickElement(data["editor"]["select_border_style_soild"])
    Logging("8. Select Border style successfully")
    commond.Wait10s_ClickElement(data["editor"]["icon_border_color"])
    commond.Wait10s_ClickElement(data["editor"]["select_color_light_red_border"])
    ...
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["click_table"])
    commond.Wait10s_ClickElement(data["editor"]["table_cell"])
    Logging("3. Click Table - Cells successfully")
    commond.Wait10s_ClickElement(data["editor"]["merge_cells"])
...
def editor_copy_paste_task(domain_name):
    ...
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["btn_more"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["btn_modify"])
    ...
    commond.SwitchToFrame_no(data["editor"]["input_editor"])
    commond.Wait10s_InputElement_return(data["editor"]["input_editor_tynmce"],data["editor"]["copy_task_new"])
    driver.switch_to.default_content()
    time.sleep(1)
    ...
    time.sleep(1)
    commond.Wait10s_InputElement(data["editor"]["txt_name_task"],data["editor"]["name_task_copy"])
    time.sleep(1)
...
def editor_format_content(domain_name):    
    ...
    commond.SwitchToFrame_no(data["editor"]["input_editor"])
    commond.Wait10s_InputElement_return(data["editor"]["input_editor_tynmce"],data["editor"]["content0_format"])
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["click_tools"])
    Logging("=> Click Tool  => Pass")
    commond.Wait10s_ClickElement(data["editor"]["click_source_code"])
    ...
    time.sleep(3)
    commond.Wait10s_ClickElement(data["editor"]["btn_cancel_source"])
    ...
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["icon_txt_text_corlor"])
    commond.Wait10s_ClickElement(data["editor"]["select_color_back"])
    Logging("===========  Size Text  ============ ")
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["icon_font_size"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["font_size_text"])
    time.sleep(1)
    ...
    commond.SwitchToFrame_no(data["editor"]["input_editor"])
    commond.Wait10s_InputElement_return(data["editor"]["input_editor_tynmce"],data["editor"]["content2_format"])
    Logging("=> Click Size Text  => Pass")
    
    Logging("===========  Font style  ============ ")
    time.sleep(1)
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["click_icon_font_style"])
    commond.Wait10s_ClickElement(data["editor"]["select_font_style"])
    time.sleep(1)
    ...
    time.sleep(3)
    commond.SwitchToFrame_no(data["editor"]["input_editor"])
    commond.Wait10s_InputElement_return(data["editor"]["input_editor_tynmce"],data["editor"]["content3_format"])
    time.sleep(1)
    ...
    commond.SwitchToFrame_no(data["editor"]["input_editor"])
    commond.Wait10s_InputElement_return(data["editor"]["input_editor_tynmce"],data["editor"]["content4_format"])
    ...
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["click_icon_align"])
    commond.Wait10s_ClickElement(data["editor"]["select_align_left"])
    commond.Wait10s_ClickElement(data["editor"]["icon_line_height"])
    commond.Wait10s_ClickElement(data["editor"]["select_line_height12"])
    editor_frame = driver.find_element_by_class_name("tox-edit-area__iframe")
    driver.switch_to.frame(editor_frame)
    content_input = driver.find_element_by_xpath("//body[@id='tinymce']")
    time.sleep(1)
    ...
    time.sleep(1)
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["icon_backgr_color_text"])
    Logging("1. Click Icon Background Color successfully")
    commond.Wait10s_ClickElement(data["editor"]["select_color_red"])
    Logging("2. Select Color successfully")

    commond.SwitchToFrame_no(data["editor"]["input_editor"])
    commond.Wait10s_InputElement_return(data["editor"]["input_editor_tynmce"],data["editor"]["content8_format"])
    driver.switch_to.default_content()
    Logging("3. Input Content Editor successfully")
    ...
    commond.Wait10s_ClickElement(data["editor"]["icon_backgr_color_text"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["select_color_write"])
    time.sleep(1)

    Logging("===========  Check box  ============ ")
    time.sleep(1)
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["icon_insert_checklist"])
    commond.SwitchToFrame_no(data["editor"]["input_editor"])
    commond.Wait10s_InputElement_return(data["editor"]["input_editor_tynmce"],data["editor"]["content6_format"])
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["icon_insert_checklist"])
    ...
    time.sleep(1)
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["icon_insert_numbered_list"])
    commond.Wait10s_ClickElement(data["editor"]["select_numbered_list_abc"])
    commond.SwitchToFrame_no(data["editor"]["input_editor"])
    commond.Wait10s_InputElement_return(data["editor"]["input_editor_tynmce"],data["editor"]["content7_format"])
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["icon_uncheck_numbered_list"])
    Logging("=> Click Numbered List  => Pass")
    Logging("=========== Formats Heading  ============ ")
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["btn_format_editor"])
    Logging("1. Click Format in Editor successfully")
    commond.Wait10s_ClickElement(data["editor"]["select_value_formats"])
    Logging("2. Select Value Formats successfully")
    commond.Wait10s_ClickElement(data["editor"]["select_value_headings"])
    Logging("3. Select Value Heading successfully")
    commond.Wait10s_ClickElement(data["editor"]["select_headings_1"])
    Logging("4. Select Value Heading 1 successfully")
    driver.execute_script("window.scrollTo(0, 100)")
    commond.SwitchToFrame_no(data["editor"]["input_editor"])
    commond.Wait10s_InputElement_return(data["editor"]["input_editor_tynmce"],data["editor"]["content9_format"])
    driver.switch_to.default_content()
    Logging("=========== Emoticons  ============ ")
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["select_icon_emoticons"])
    Logging("1. Click icon Emoticons successfully")
    commond.Wait10s_ClickElement(data["editor"]["select_icon_100"])
    ...
    driver.switch_to.default_content()
    commond.Wait10s_ClickElement(data["editor"]["click_format"])
    Logging("1. Click tab Format successfully")
    commond.Wait10s_ClickElement(data["editor"]["click_strikethrough"])
    Logging("1. Click Strikethrough successfully")
    driver.execute_script("window.scrollTo(0, 100)")
    commond.SwitchToFrame_no(data["editor"]["input_editor"])
    commond.Wait10s_InputElement_return(data["editor"]["input_editor_tynmce"],data["editor"]["content10_format"])
    driver.switch_to.default_content()
    time.sleep(1)
    ...
    commond.Wait10s_ClickElement(data["editor"]["icon_insearch_image_editor"])
    Logging("11. Click icon Insert  successfully")
    commond.Wait10s_clearElement(data["editor"]["txt_width"])
    commond.Wait10s_InputElement(data["editor"]["txt_width"],data["editor"]["number_width"])
    ...
    commond.Wait10s_ClickElement(data["editor"]["select_border_style_soild"])
    Logging("8. Click tab Advanced Table Properties successfully")
    commond.Wait10s_clearElement(data["editor"]["txt_border_width"])
    commond.Wait10s_InputElement(data["editor"]["txt_border_width"],data["editor"]["number_border_width_image"])
    Logging("=> Input Border width successfully")
    commond.Wait10s_ClickElement(data["editor"]["btn_save_insert_image"])
    time.sleep(3)
    Logging("===========  Full Screen  ============ ")
    commond.Wait10s_ClickElement(data["editor"]["btn_full_screen"])
    commond.Wait10s_ClickElement(data["editor"]["btn_full_screen"])
...
def editor_upload_office_file(domain_name):
    ...
    if 'Automatically saved file found' in driver.page_source :
        ...
        Logging("2. Not show Automatically saved file found")
    commond.Wait10s_InputElement(data["editor"]["txt_name_task"],data["editor"]["title_upload_office_file"])
    time.sleep(1)
    Logging("2. Input Title Task successfully")
    commond.Wait10s_ClickElement(data["editor"]["btn_view_office_file_html"])
    time.sleep(2)
...
def editor_rotate_clockwise_image(domain_name):
    ...
    commond.Wait10s_ClickElement(data["editor"]["btn_save_insert_image"])
    Logging("=> Upload  Image successfully")
    commond.Wait10s_ClickElement(data["editor"]["icon_rotate_clockwise"])
    ...
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["btn_back_task"])
    driver.refresh()
    time.sleep(6)
    commond.Wait10s_ClickElement(data["editor"]["checkbox_all"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["btn_more"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["editor"]["btn_delete"])
    time.sleep(1)
    Logging("8. Click button Delete successfully")
    commond.Wait10s_ClickElement(data["editor"]["btn_ok_delete_task"])
