...
def board_create_folder(domain_name):
    ...
    now = datetime.now()
    name_folder_board = "Generated sele" +" " + now.strftime("%Y")
    input_description_board = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["board"]["input_folder_name_board"])))
    input_description_board.send_keys(name_folder_board)
    time.sleep(2)
