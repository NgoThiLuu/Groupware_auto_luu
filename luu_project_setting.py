...
from luu_function import local, data, Logging, ValidateFailResultAndSystem,TestCase_LogResult,Yellow,Green,Red,Commands
...
def project_create_folder(domain_name):
    ...
    time.sleep(1)
    Commands.Wait10s_ClickElement(data["project"]["manage_folder_project"])
    Logging("2. Click Manage Folder successfully")
    time.sleep(1)
    Commands.Wait10s_ClickElement(data["project"]["folder_list_project"])
    Logging("2. Click list name Project successfully")
    Commands.Wait10s_ClickElement(data["project"]["icon_plus_project"])
    ...
    Commands.Wait10s_ClickElement(data["project"]["button_save_folder_project"])
    time.sleep(1)
...
def project_create_subfolder(domain_name):
    ...
    Commands.Wait10s_ClickElement(data["project"]["manage_folder_project"])
    Commands.Wait10s_ClickElement(data["project"]["icon_list_project"])
    Commands.Wait10s_ClickElement(data["project"]["select_parent_folder_project"])
    time.sleep(1)
    Commands.Wait10s_ClickElement(data["project"]["icon_close_list_project"])
    time.sleep(1)
    Commands.Wait10s_InputElement(data["project"]["input_sub_folder_name_project"],data["project"]["subfolder_name_project"])
    Logging("8. Input Subfolder Project successfully" + " :  " + data["project"]["subfolder_name_project"])
    Commands.Wait10s_ClickElement(data["project"]["button_save_sub_folder_project"])
    time.sleep(1)
    Logging("9. Save Subfolder Project successfully")
    time.sleep(1)
    Commands.Wait10s_ClickElement(data["project"]["manage_folder_project"])
    Commands.Wait10s_ClickElement(data["project"]["parent_folder_project"])
    time.sleep(1)
    WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["project"]["show_folder_create"])))
    ...
    time.sleep(1)
    Commands.Wait10s_ClickElement(data["project"]["select_subfolder_project_delete"])
    time.sleep(1)
    Logging("12. Select Subfolder Project successfully")
    Commands.Wait10s_ClickElement(data["project"]["icon_delete_subfolder_project"])
    time.sleep(1)
    Logging("13. Click icon delete successfully")
    Commands.Wait10s_ClickElement(data["project"]["ok_button_project"])
...
def project_add_manager(domain_name):
    ...
    Commands.Wait10s_ClickElement(data["project"]["admin_project"])
    Logging("1. Click Admin Project successfully")
    Commands.scroll_view(data["project"]["admin_manager"])
    time.sleep(1)
    Commands.Wait10s_ClickElement(data["project"]["admin_manager"])
    Logging("2. Click Manager Project successfully")
    time.sleep(1)
    Commands.Wait10s_ClickElement(data["project"]["manager_project_all_user"])
    ...
    Commands.Wait10s_ClickElement(data["project"]["btn_save_admin_maanger"])
    time.sleep(1)
    ...
    if click_close_button_admin_manager.is_displayed():
        Commands.Wait10s_ClickElement(data["project"]["btn_close_admin_maanger"])
    ...
    Commands.Wait10s_ClickElement(data["project"]["manager_project_select_manager"])
...
def project_add_extension_form(domain_name):
    ...
    Commands.scroll_view(data["project"]["click_set_extenssion"])
    time.sleep(1)
    Commands.Wait10s_ClickElement(data["project"]["click_set_extenssion"])
    Logging("1. Click Set extension form Project successfully")
    Commands.Wait10s_ClickElement(data["project"]["icon_craete_extenssion_form"])
    Logging("2. Click icon Create Set extension form Project successfully")
    time.sleep(1)
    Commands.Wait10s_InputElement(data["project"]["txt_form_name_extension_project"],data["project"]["form_name_extension_project"])
    Commands.Wait10s_ClickElement(data["project"]["select_form_type"])
    Logging("4. Select Form type Text successfully")
    Commands.Wait10s_ClickElement(data["project"]["btn_save_extension_form_project"])
    Logging("5. Click button Save extension form Project successfully")
    Commands.Wait10s_ClickElement(data["project"]["btn_close_save_extension_form"])
    ...
    Commands.Wait10s_InputElement(data["project"]["txt_search_form_name_delete"],data["project"]["form_name_extension_project"])
    time.sleep(1)
    Logging("1. Show form name Search successfully")
    Commands.Wait10s_ClickElement(data["project"]["icon_checkbox_all"])
    Logging("2. Click checkbox all successfully")
    time.sleep(1)
    Commands.Wait10s_ClickElement(data["project"]["btn_delete_form"])
    Logging("3. Click button Delete successfully")
    Commands.Wait10s_ClickElement(data["project"]["btn_ok"])
...
def project_add_work_type(domain_name):
    ...
    Commands.Wait10s_ClickElement(data["project"]["click_manager_work_type"])
    Logging("1. Click Manage Work Type successfully")
    Commands.Wait10s_ClickElement(data["project"]["icon_create_work_type"])
    Logging("2. Click icon Create Manage Work Type successfully")
    Commands.Wait10s_InputElement(data["project"]["txt_type_name"],data["project"]["name_work_type"])
    Logging("3. Input Work Type  successfully")
    Commands.Wait10s_ClickElement(data["project"]["turn_off_work_type"])
    Logging("4. Turn Off Work Type successfully")
    Commands.Wait10s_ClickElement(data["project"]["btn_save_work_type_project"])
    ...
    time.sleep(1)
    Commands.Wait10s_InputElement_return(data["project"]["txt_work_type"],data["project"]["name_work_type"])
    Logging("1. Show form name Search successfully")
    Commands.Wait10s_ClickElement(data["project"]["check_box_work_name_search"])
    Logging("2. Click checkbox all successfully")
    Commands.Wait10s_ClickElement(data["project"]["btn_delete_work_type"])
    Logging("3. Click button Delete successfully")
    time.sleep(1)
    ...
    Commands.Wait10s_ClickElement(data["project"]["btn_ok_delete_work_type"])
