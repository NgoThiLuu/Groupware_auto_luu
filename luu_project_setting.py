...
def project_create_folder(domain_name):
    ...
    select_manager_folders = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["manage_folder_project"])))
    select_manager_folders.click()
    Logging("2. Click Manage Folder successfully")
    time.sleep(1)
    select_list_project = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["folder_list_project"])))
    select_list_project.click()
    Logging("2. Click list name Project successfully")
    click_icon_plus_project = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["icon_plus_project"])))
    click_icon_plus_project.click()
    Logging("3. Click icon plus successfully")
    folder_name_manage_project = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["input_folder_mane_project"])))
...
def project_create_subfolder(domain_name):
    ...
    select_manager_folders = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["manage_folder_project"])))
    select_manager_folders.click()
    click_project_folder_name = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["icon_list_project"])))
    click_project_folder_name.click()
    select_parent_folder_project = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["select_parent_folder_project"])))
    select_parent_folder_project.click()
    time.sleep(1)
    close_list_parent_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["icon_close_list_project"])))
    close_list_parent_folder.click()
    time.sleep(1)
    subfolder_name_manage_project = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["input_sub_folder_name_project"])))
    ...
    select_manager_folders = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["manage_folder_project"])))
    select_manager_folders.click()
    click_parent_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["parent_folder_project"])))
    ...
    time.sleep(1)
    select_subfolder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["select_subfolder_project_delete"])))
    ...
    ok_button_folder_project = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["ok_button_project"])))
...
def project_delete_folder(domain_name):
    ...
    click_icon_delete = driver.find_element_by_xpath("//a[contains(@ng-click, 'deleteFolder($event)')]")
    click_icon_delete.click()
    ok_button_folder_project = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["ok_button_project"])))
    ok_button_folder_project.click()
...
def project_add_manager(domain_name):
    ...
    click_admin_project = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["admin_project"])))
    click_admin_project.click()
    Logging("1. Click Admin Project successfully")
    element = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["project"]["admin_manager"])))
    element.location_once_scrolled_into_view
    time.sleep(1)
    click_admin_manager = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["admin_manager"])))
    click_admin_manager.click()
    Logging("2. Click Manager Project successfully")
    time.sleep(1)
    click_all_user_manager = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["manager_project_all_user"])))
    ...
    click_save_button_admin_manager = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["btn_save_admin_maanger"])))
    ...
    click_org_select_user_manager = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["manager_project_select_manager"])))
...
def project_add_extension_form(domain_name):
    ...
    element = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["project"]["click_set_extenssion"])))
    element.location_once_scrolled_into_view
    time.sleep(1)
    click_set_extension_form = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["click_set_extenssion"])))
    click_set_extension_form.click()
    Logging("1. Click Set extension form Project successfully")
    click_icon_create_extension_form = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["icon_craete_extenssion_form"])))
    click_icon_create_extension_form.click()
    Logging("2. Click icon Create Set extension form Project successfully")
    time.sleep(1)
    input_form_name_extension = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["project"]["txt_form_name_extension_project"])))
    ...
    click_form_type_text = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["select_form_type"])))
    click_form_type_text.click()
    Logging("4. Select Form type Text successfully")
    click_btn_save_extension_form = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["btn_save_extension_form_project"])))
    click_btn_save_extension_form.click()
    Logging("5. Click button Save extension form Project successfully")
    click_btn_close_extension_form = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["btn_close_save_extension_form"])))
    ...
    search_form_name_extension = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["project"]["txt_search_form_name_delete"])))
    ...
    check_all_extension_form_search = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["icon_checkbox_all"])))
    check_all_extension_form_search.click()
    Logging("2. Click checkbox all successfully")
    time.sleep(1)
    click_btn_delete = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["btn_delete_form"])))
    click_btn_delete.click()
    Logging("3. Click button Delete successfully")
    click_btn_ok = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["btn_ok"])))
    click_btn_ok.click()
    Logging("4. Click button OK successfully")
    click_btn_close_delete = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["btn_close_save_extension_form"])))
...
def project_add_work_type(domain_name):
    ...
    click_manager_work_type = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["click_manager_work_type"])))
    click_manager_work_type.click()
    Logging("1. Click Manage Work Type successfully")
    click_icon_create_manager_work_type = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["icon_create_work_type"])))
    click_icon_create_manager_work_type.click()
    Logging("2. Click icon Create Manage Work Type successfully")
    input_manager_work_type = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["project"]["txt_type_name"])))
    input_manager_work_type.send_keys(data["project"]["name_work_type"])
    Logging("3. Input Work Type  successfully")
    turn_off_work_type = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["turn_off_work_type"])))
    turn_off_work_type.click()
    Logging("4. Turn Off Work Type successfully")
    click_btn_save_work_type = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["btn_save_work_type_project"])))
    ...
    time.sleep(1)
    search_work_type = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["project"]["txt_work_type"])))
    search_work_type.send_keys(data["project"]["name_work_type"])
    search_work_type.send_keys(Keys.RETURN)
    Logging("1. Show form name Search successfully")
    check_all_work_name_search = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["check_box_work_name_search"])))
    check_all_work_name_search.click()
    Logging("2. Click checkbox all successfully")
    click_btn_delete = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["btn_delete_work_type"])))
    click_btn_delete.click()
    Logging("3. Click button Delete successfully")
    time.sleep(1)
    ...
    time.sleep(1)
    '''
    click_btn_ok = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, data["project"]["btn_ok_delete_work_type"])))
    click_btn_ok.click()
    Logging("Delete Manage Work Type => FAIL")
