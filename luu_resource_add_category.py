...
import luu_function
from luu_function import local, data, Logging, ValidateFailResultAndSystem,TestCase_LogResult,Red,Yellow,Green,Wait10s_ClickElement,Wait10s_InputElement
...
def resource_add_category(domain_name):
    ...
    time.sleep(1)
    Wait10s_ClickElement(data["resource"]["add_resource"])
    time.sleep(1)
    Wait10s_ClickElement(data["resource"]["select_add_resource"])
    time.sleep(1)
    Wait10s_ClickElement(data["resource"]["icon_plus"])
    Logging("3.Click Icon Plus successfully")
    Wait10s_ClickElement(data["resource"]["select_type"])
    Logging("4.Select Type Category successfully")
    Wait10s_ClickElement(data["resource"]["select_type"])
    Logging("4.Select Type Category successfully")
    Wait10s_InputElement(data["resource"]["txt_category_name"],data["resource"]["input_category_name"])
    Logging("5. Input Category Name successfully" + " :  " + data["resource"]["input_category_name"])
    Wait10s_ClickElement(data["resource"]["btn_save_resource_name"])
    time.sleep(1)
    ...
    Wait10s_ClickElement(data["resource"]["select_type_vehicle"])
    Logging("2.Select Type Category successfully")

    Wait10s_InputElement(data["resource"]["txt_category_name"],data["resource"]["input_category_name_vehicle"])
    ...
    Wait10s_ClickElement(data["resource"]["icon_plus"])
    Logging("1.Click Icon Plus successfully")
    Wait10s_ClickElement(data["resource"]["select_type_normal"])
    Logging("2.Select Type Category successfully")
    Wait10s_InputElement(data["resource"]["txt_category_name"],data["resource"]["input_category_name_normal"])
...
def resource_add_resource_category_room(domain_name):
    ...
    Wait10s_ClickElement(data["resource"]["select_category_add"])
    Logging("4.Select Category  successfully")
    Wait10s_ClickElement(data["resource"]["icon_plus_meeting_room"])
    ...
    Wait10s_InputElement(data["resource"]["txt_conference_room_name"],data["resource"]["conference_room_name"])
    ...
    Wait10s_InputElement(data["resource"]["txt_description_conference_room_name"],data["resource"]["description_conference_room_content"])
    ...
    Wait10s_ClickElement(data["resource"]["click_org_user_permisson"])
    ...
    time.sleep(1)
    Wait10s_ClickElement(data["resource"]["select_user_permisson_2"])
    Wait10s_ClickElement(data["resource"]["icon_add_user_per"])
    time.sleep(1)
    Logging("12.Add User  successfully")
    Wait10s_ClickElement(data["resource"]["click_button_save_per"])
    ...
    Wait10s_ClickElement(data["resource"]["click_button_save_add_resource"])
    ...
    time.sleep(1)
    Logging("5.Click Icon Plus successfully")
    Wait10s_InputElement(data["resource"]["txt_conference_room_name"],data["resource"]["conference_room_name_sytem"])
    ...
    Wait10s_ClickElement(data["resource"]["permisson_system"])
    Logging("2.Check Permission System successfully")
    Wait10s_InputElement(data["resource"]["txt_description_conference_per_system"],data["resource"]["description_conference_room_sytem"])
...
def resource_add_resource_category_vehicle(domain_name):
    ...
    driver.execute_script("window.scrollTo(document.body.scrollHeight,0)")
    time.sleep(1)
    Wait10s_ClickElement(data["resource"]["select_category_vehicle"])
    time.sleep(1)
    Logging("4.Select Category  successfully")
    Wait10s_ClickElement(data["resource"]["icon_plus_vehicle"])
    Logging("5.Click Icon Plus successfully")
    Wait10s_InputElement(data["resource"]["txt_conference_room_name_reser_vehicle"],data["resource"]["vehicle_reser_room_name"])
    Logging("=>  Input Room Name successfully" + " :  " + data["resource"]["vehicle_reser_room_name"]) 
    Wait10s_InputElement(data["resource"]["txt_car_number"],data["resource"]["input_car_number"])
    Logging("=>  Input Car Number successfully" + " :  " + data["resource"]["input_car_number"])
    Wait10s_InputElement(data["resource"]["txt_vin"],data["resource"]["input_vin_number"])
    Logging("=>  Input VIN successfully" + " :  " + data["resource"]["input_vin_number"])
    Wait10s_InputElement(data["resource"]["txt_mileage"],data["resource"]["input_mileage_number"])
    Logging("=>  Input VIN successfully" + " :  " + data["resource"]["input_mileage_number"])

    driver.execute_script("window.scrollTo(0, 100)")
    Wait10s_ClickElement(data["resource"]["check_date_vihicle"])
    ...
    Wait10s_ClickElement(data["resource"]["select_status_malfunctioning"])
    time.sleep(1)
...
def resource_add_resource_category_normal(domain_name):
    ...
    driver.execute_script("window.scrollTo(document.body.scrollHeight,0)")
    time.sleep(1)
    Wait10s_ClickElement(data["resource"]["select_category_normal"])
    time.sleep(1)
    Logging("4.Select Category  successfully")
    Wait10s_ClickElement(data["resource"]["icon_plus_vehicle"])
    time.sleep(1)
    Logging("5.Click Icon Plus successfully")
    Wait10s_InputElement(data["resource"]["txt_conference_room_name_reser_vehicle"],data["resource"]["normal_reser_room_name"])
...
def resource_delete_category(domain_name):    
    ...
    driver.execute_script("window.scrollTo(document.body.scrollHeight,0)")
    time.sleep(2)
    Wait10s_ClickElement(data["resource"]["select_category_room_delete"])
    time.sleep(1)
    Logging("1.Select Category  successfully")
    Wait10s_ClickElement(data["resource"]["delete_category"])
    Logging("2.Click Icon Delete successfully")
    time.sleep(1)
    Wait10s_ClickElement(data["resource"]["btn_ok_delete_category"])
    time.sleep(1)
    driver.execute_script("window.scrollTo(document.body.scrollHeight,0)")
    time.sleep(2)
    Wait10s_ClickElement(data["resource"]["select_category_normal_delete"])
    Logging("1.Select Category  successfully")
    Wait10s_ClickElement(data["resource"]["delete_category"])
    Logging("2.Click Icon Delete successfully")
    Wait10s_ClickElement(data["resource"]["btn_ok_delete_category"])
    ...
    driver.execute_script("window.scrollTo(document.body.scrollHeight,0)")
    time.sleep(2)
    Wait10s_ClickElement(data["resource"]["select_category_vehicle_delete"])
    time.sleep(2)
    Logging("1.Select Category  successfully")
    Wait10s_ClickElement(data["resource"]["delete_category"])
    Logging("2.Click Icon Delete successfully")
    ...
    Wait10s_ClickElement(data["resource"]["collapsible_icon_resource"])
    time.sleep(2)
    ...
    if click_resource_list.is_displayed():
        ...
        Wait10s_ClickElement(data["resource"]["collapsible_icon_add_resource"])   
    time.sleep(2)
    Wait10s_ClickElement(data["resource"]["click_resource_list"])
    time.sleep(2)
    ...
    time.sleep(1)
    Wait10s_ClickElement(data["resource"]["click_resource_list_icon_filter_status"])
    Wait10s_ClickElement(data["resource"]["filter_status_malfunctioning"])
    time.sleep(6)
...
def resource_add_resource_manager(domain_name):
    ...
    time.sleep(1)
    Wait10s_ClickElement(data["resource"]["click_add_reource_manager"])
    Logging("1.Click Folder Name successfully")
    Wait10s_ClickElement(data["resource"]["icon_folder_name_resource_manager"])
    ...
    time.sleep(1)
    Wait10s_ClickElement(data["resource"]["select_user_manager_resource"])
    Logging("4.Select user successfully")
    Wait10s_ClickElement(data["resource"]["btn_save_add_manager_resource"])
    Logging("5.Button Save successfully")
    Wait10s_ClickElement(data["resource"]["manager_list_resource"])
    ...
    Wait10s_ClickElement(data["resource"]["check_user_delete"])
    Logging("1. Select User Delete successfully")
    Wait10s_ClickElement(data["resource"]["btn_delete_manager_list_resource"])
    time.sleep(1)
    Logging("2. Click button Delete successfully")
    Wait10s_ClickElement(data["resource"]["btn_ok_delete_manager_list"])
    time.sleep(1)
