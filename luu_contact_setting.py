...
def contact_create_folder(domain_name):
    ...
    list_company_contact = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, "//*[starts-with(@id, 'mCSB') and contains(@id, 'container')]//li[contains(@data-category,'org')]//span[contains(.,'My Company')]/following-sibling::b")))
    list_company_contact.click()
    time.sleep(2)
    click_setting = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["setting_contact"])))
    click_setting.click()
    time.sleep(2)
    Logging("2. Click list My Company successfully")    
    folder_list = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["folder_my_contacts"])))
    folder_list.click()
    Logging("4. Click folder in My Contacts successfully")
    folder_name = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["textbox_folder_name"])))
    ...
    folder_description = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["textbox_description"])))
    ...
    click_share = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["turn_on_share"])))
    click_share.click()
    click_org = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_org_contact"])))
    click_org.click()
    time.sleep(1)
    select_user = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["share_invite_user_dept"])))
    select_user.click()
    time.sleep(1)
    ...
    add_user = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_icon_add_user"])))
    add_user.click()
    time.sleep(1)
    ...
    click_save_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["save_folder_my_contact"])))
    click_save_folder.click()
    time.sleep(1)
    click_button_close_contact = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_button_close_contact"])))
...
def contact_create_subfolder(domain_name):    
    ...
    click_list_my_contacts = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, "//label/i")))
    click_list_my_contacts.click()
    select_parent_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["select_parent_folder_contact"])))
    select_parent_folder.click()
    time.sleep(1)
    Logging("10. Select Parent folder successfully")
    folder_name = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["input_sub_folder_contacts"])))
    ...
    click_save_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["save_subfolder_contact"])))
    click_save_folder.click()
    time.sleep(2)
    click_button_close_contact = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_button_close_contact"])))
    click_button_close_contact.click()
    ...
    driver.execute_script("window.scrollTo(100, 0)")
    time.sleep(1)
    click_folder_par = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["check_folder_parent_contact"])))
    ...
    driver.execute_script("window.scrollTo(100, 0)")
    time.sleep(1)
    click_subfolders = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["select_subfolder_contact_delete"])))
    ...
    if 'sub 2' in driver.page_source :
        Logging("1.Delete SubFolder My Contact =>  FAIL")
        ValidateFailResultAndSystem("<div>[Contact]Write SubFolder My Contact </div>")
        TestCase_LogResult(**data["testcase_result"]["contact"]["delete_subfolder_contact"]["fail"])
    else:
        Logging("1.Delete SubFolder My Contact =>  PASS")
...
def contact_edit_folder(domain_name):    
    ...
    click_save_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["save_folder_contact_edit"])))
    click_save_folder.click()
    time.sleep(1)
    click_button_close_contact = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_button_close_contact"])))
    click_button_close_contact.click()
...
def contact_delete_folder(domain_name):    
    ...
    driver.execute_script("window.scrollTo(100, 0)")
    time.sleep(2)
    click_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_folder_contact_edit"])))
    click_folder.click()
    time.sleep(1)
    click_delete = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_icon_delete_subfolder_contact"])))
    click_delete.click()
    time.sleep(1)
    click_ok_button = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_ok_button"])))
    click_ok_button.click()
    time.sleep(2)
    click_button_close_contact = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_button_close_contact"])))
    click_button_close_contact.click()
...
def contact_manager_folder(domain_name):
    ...
    time.sleep(1)
    click_manage_company_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_manager_company_folder"])))
    ...
    click_public_contacts = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["folder_public_contact"])))
    click_public_contacts.click()
    Logging("2. Click  Public Contact successfully")
    folder_name_manage_company = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["textbox_folder_name"])))
    ...
    click_radio_share_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["check_radio_share"])))
    click_radio_share_folder.click()
    Logging("1.Click Radio Share =>Pass")
    time.sleep(2)
    click_org_share_user = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["org_share_user_share"])))
    click_org_share_user.click()
    Logging("2.Click Organization =>Pass")
    time.sleep(3)
    select_user = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["select_dept_manager_company"])))
    select_user.click()
    time.sleep(1)
    add_user = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["icon_add_user_manager"])))
    add_user.click()
    time.sleep(1)
    element = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_save_add_user_mana"])))
    element.location_once_scrolled_into_view
    time.sleep(1)
    click_save_button = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_save_add_user_mana"])))
    click_save_button.click()
    time.sleep(1)
    ...
    time.sleep(1)
    click_save_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_save_manager_folder"])))
    click_save_folder.click()
    time.sleep(2)
    click_button_close_contact = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_button_close_contact"])))
    click_button_close_contact.click()
    Logging("9. Save folder successfully")
    element = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["pull_the_scroll_bar_view"])))
    element.location_once_scrolled_into_view
    time.sleep(1)
...
def contact_manager_edit_folder(domain_name):
    ...
    time.sleep(1)
    input_about_folder = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["txt_about_folder"])))
    input_about_folder.send_keys(data["contact"]["content_about_folder"])
    Logging("1. Input Content successfully")
    click_save_folder= WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_save_manager_folder"])))
    click_save_folder.click()
    time.sleep(1)
    click_button_close_contact = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_button_close_contact"])))
    click_button_close_contact.click()
...
def contact_manager_delete_folder(domain_name):    
    ...
    follder_manager_company.click()
    time.sleep(1)
    delete_follder_manager_company = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_delete_folder_company"])))
    delete_follder_manager_company.click()
    driver.execute_script("window.scrollTo(0, 100)")
    time.sleep(1)
    btn_ok_delete_follder_manager_company = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_ok_delete_folder_manager"])))
    btn_ok_delete_follder_manager_company.click()
    time.sleep(1)
    btn_close_delete_follder_manager_company = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_close_delete_folder_manager"])))
...
def contact_setting_general(domain_name):
    ...
    click_admin_settings = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_admin_setting"])))
    click_admin_settings.click()
    Logging("1. Click Admin Settings successfully")
    click_display_org_contact_list = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["select_view_contact_list"])))
    click_display_org_contact_list.click()
    Logging("2. Click Display Organization Contacts : LIST  successfully")
    click_btn_save_display_org_contact = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_save_view_contact"])))
    click_btn_save_display_org_contact.click()
    Logging("3. Click Display Organization Contacts : LIST  successfully")
    click_btn_close_view_contact = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_close_delete_folder_manager"])))
    click_btn_close_view_contact.click()
    Logging("4. Click Close  successfully")
    time.sleep(1)
    click_my_company_check_data = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["select_my_company"])))
    ...
    if 'A new version is available! Do you want to update?' in driver.page_source :
        update_verion = WebDriverWait(driver, 30).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_update_version"])))
        update_verion.click()
    ...
    time.sleep(1)
    click_admin_settings = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_admin_setting"]))).click()
    click_display_org_contact_photo = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["select_view_contact_photo"])))
...
def contact_setting_general_hide_my_contact(domain_name):
    ...
    time.sleep(1)
    click_hide_my_contacts = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["hide_my_contacts"])))
    ...
    click_btn_close_view_contact = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_close_delete_folder_manager"])))
    click_btn_close_view_contact.click()
    click_manage_favorites = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["manage_favorites"])))
...
def contact_setting_general_public_contact_manager(domain_name):
    ...
    click_org_select_user_contact = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["org_share_user_share"])))
    click_org_select_user_contact.click()
    Logging("1. Click Organization successfully")
    select_user_dept = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["select_user_public_dept"])))
    ...
    '''
    icon_add_user = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["icon_add_user_public"])))
    icon_add_user.click()
    time.sleep(5)

    click_save_button = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_save_user_public"])))
    ...
    click_btn_save_select_user_public = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_save_public_contact"])))
    ...
    click_org_select_user_contact.click()
    time.sleep(1)
    click_delete_user_public_contact = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["icon_delete_all_user_public"])))
...
def contact_manage_favorites(domain_name):
    ...
    Logging("1. Click Manage Favorites successfully")
    time.sleep(2)
    click_icon_favorites_list = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["icon_add_favorites_list"])))
    click_icon_favorites_list.click()
    Logging("2. Click icon Favorites List successfully")
    time.sleep(2)
    name_folder_favorites = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["txt_folder_name_favorites"])))
    ...
    time.sleep(2)
    click_org_manage_favorites = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["click_icon_org"])))
    ...
    icon_add_user = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["icon_add_user_favorites"])))
    icon_add_user.click()
    time.sleep(2)
    click_save_button = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_save_user_favorites"])))
    click_save_button.click()
    time.sleep(1)
    Logging("5. Select user Favorites successfully")
    input_description = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["txt_description_add_folder"])))
    ...
    time.sleep(2)
    btn_close_delete_follder_manager_favorites = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_close_delete_folder_favorites"])))
    ...
    select_folder_favorites_delete = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["select_folder_favorites_delete"])))
    select_folder_favorites_delete.click()
    Logging("1. Click Folder Favorites Delete successfully")
    click_btn_delete = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_delete_folder_favorites"])))
    click_btn_delete.click()
    Logging("2. Click button Delete successfully")
    click_btn_ok_delete_folder_favorites = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_ok_folder_favorites"])))
    click_btn_ok_delete_folder_favorites.click()
    Logging("3. Click button Delete successfully")
    click_btn_close_delete_folder_favorites = WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_close_delete_folder_favorites"])))
