...
from luu_function import driver, local, data, Logging, ValidateFailResultAndSystem,TestCase_LogResult,Yellow,Red,Green,commond
...
def contact_create_folder(domain_name):
    ...
    Logging("------------------------------------------------------C. Menu Contact------------------------------------------------------")
    #driver.get(domain_name + "/addrbook/list/org_0/")  
    commond.Wait10s_ClickElement(data["contact"]["hide_list_contact"])
    time.sleep(2)
    commond.Wait10s_ClickElement(data["contact"]["setting_contact"])
    time.sleep(2)
    Logging("2. Click list My Company successfully")  
    commond.Wait10s_ClickElement(data["contact"]["folder_my_contacts"])  
    ...
    commond.Wait10s_InputElement(data["contact"]["textbox_description"],data["contact"]["title_description"])
    Logging("6. Input Description successfully" + " :  " +  data["contact"]["title_description"] )
    commond.Wait10s_ClickElement(data["contact"]["turn_on_share"]) 
    commond.Wait10s_ClickElement(data["contact"]["click_org_contact"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["share_invite_user_dept"])
    time.sleep(1)
    ...
    commond.Wait10s_ClickElement(data["contact"]["click_icon_add_user"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["save_add_user"])
    ...
    commond.Selectbox_ByVisibleText(data["contact"]["select_permission"],data["contact"]["select_per_contact"])

    Logging("8. Select  Permissison successfully")
    commond.Wait10s_ClickElement(data["contact"]["save_folder_my_contact"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["click_button_close_contact"])
...
def contact_create_subfolder(domain_name):    
    ...
    commond.Wait10s_ClickElement(data["contact"]["click_list_my_contact"])
    commond.Wait10s_ClickElement(data["contact"]["select_parent_folder_contact"])
    time.sleep(1)
    Logging("10. Select Parent folder successfully")
    commond.Wait10s_InputElement(data["contact"]["input_sub_folder_contacts"],data["contact"]["subfolder_name"])
    Logging("11. Input subfolder Name successfully" + " :  " + data["contact"]["subfolder_name"] )
    Logging("11. Save Subfolder successfully")
    commond.Wait10s_ClickElement(data["contact"]["save_subfolder_contact"])
    time.sleep(2)
    commond.Wait10s_ClickElement(data["contact"]["click_button_close_contact"])
    Logging("12. Save folder successfully")
    driver.execute_script("window.scrollTo(100, 0)")
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["check_folder_parent_contact"])
    time.sleep(2)
    ...
    driver.execute_script("window.scrollTo(100, 0)")
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["select_subfolder_contact_delete"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["click_icon_delete_subfolder_contact"])
    commond.Wait10s_ClickElement(data["contact"]["click_ok_button"])
    commond.Wait10s_ClickElement(data["contact"]["click_button_close_contact"])
    time.sleep(1)
...
def contact_edit_folder(domain_name):    
    ...
    commond.Selectbox_ByVisibleText(data["contact"]["edit_permisssion_contacts"],data["contact"]["edit_permission_contact"])
    ...
    commond.Wait10s_ClickElement(data["contact"]["save_folder_contact_edit"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["click_button_close_contact"])
...
def contact_delete_folder(domain_name):    
    ...
    driver.execute_script("window.scrollTo(100, 0)")
    time.sleep(2)
    commond.Wait10s_ClickElement(data["contact"]["click_folder_contact_edit"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["click_icon_delete_subfolder_contact"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["click_ok_button"])
...
def contact_manager_folder(domain_name):
    ...
    if click_manage_company_folder.is_displayed():
       click_manage_company_folder.click()
        ...
        commond.Wait10s_ClickElement(data["contact"]["admin_contact"])
        time.sleep(1)
        commond.Wait10s_ClickElement(data["contact"]["click_manager_company_folder"])
    time.sleep(2)
    Logging("1. Click  Manage Company Folders successfully")
    commond.Wait10s_ClickElement(data["contact"]["folder_public_contact"])
    ...
    commond.Wait10s_ClickElement(data["contact"]["check_radio_share"])
    Logging("1.Click Radio Share =>Pass")
    time.sleep(2)
    commond.Wait10s_ClickElement(data["contact"]["org_share_user_share"])
    Logging("2.Click Organization =>Pass")
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["select_dept_manager_company"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["icon_add_user_manager"])
    time.sleep(1)
    WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["btn_save_add_user_mana"])))
    commond.scroll_view(data["contact"]["btn_save_add_user_mana"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["btn_save_add_user_mana"])
    time.sleep(1)
    ...
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["btn_save_manager_folder"])
    time.sleep(2)
    commond.Wait10s_ClickElement(data["contact"]["click_button_close_contact"])
    Logging("9. Save folder successfully")
    WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["pull_the_scroll_bar_view"])))
    commond.scroll_view(data["contact"]["pull_the_scroll_bar_view"])
    time.sleep(1)
    WebDriverWait(driver, 10).until(EC.presence_of_element_located((By.XPATH, data["contact"]["pull_the_scroll_bar_view"])))
...
def contact_manager_edit_folder(domain_name):
    ...
    driver.execute_script("window.scrollTo(100, 0)")
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["pull_the_scroll_bar_view"])
    time.sleep(1)
    commond.Wait10s_InputElement(data["contact"]["txt_about_folder"],data["contact"]["txt_about_folder"])
...
def contact_manager_delete_folder(domain_name):    
    ...
    commond.Wait10s_ClickElement(data["contact"]["pull_the_scroll_bar_view"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["btn_delete_folder_company"])
    driver.execute_script("window.scrollTo(0, 100)")
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["btn_ok_delete_folder_manager"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["btn_close_delete_folder_manager"])
    time.sleep(1)
...
def contact_setting_general(domain_name):
    ...
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["click_admin_setting"])
    commond.Wait10s_ClickElement(data["contact"]["select_view_contact_photo"])
    time.sleep(1)
...
def contact_setting_general_hide_my_contact(domain_name):
    ...
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["hide_my_contacts"])
    Logging("7. Click Hide My Contacts  successfully")
    commond.Wait10s_ClickElement(data["contact"]["btn_save_view_contact"])
    commond.Wait10s_ClickElement(data["contact"]["btn_close_delete_folder_manager"])
    commond.Wait10s_ClickElement(data["contact"]["manage_favorites"])
...
def contact_setting_general_public_contact_manager(domain_name):
    ...
    commond.Wait10s_ClickElement(data["contact"]["select_user_public_dept"])
    '''
    ...
    '''
    commond.Wait10s_ClickElement(data["contact"]["icon_add_user_public"])
    time.sleep(5)
    commond.Wait10s_ClickElement(data["contact"]["btn_save_user_public"])
    Logging("2. Select user Public successfully")
    commond.Wait10s_ClickElement(data["contact"]["btn_save_public_contact"])
    time.sleep(3)
    commond.Wait10s_ClickElement(data["contact"]["btn_close_delete_folder_manager"])
    ...
    commond.Wait10s_ClickElement(data["contact"]["org_share_user_share"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["icon_delete_all_user_public"])
    time.sleep(5)
...
def contact_manage_favorites(domain_name):
    ...
    Logging("1. Click Manage Favorites successfully")
    time.sleep(2)
    commond.Wait10s_ClickElement(data["contact"]["icon_add_favorites_list"])
    Logging("2. Click icon Favorites List successfully")
    time.sleep(2)
    commond.Wait10s_InputElement(data["contact"]["txt_folder_name_favorites"],data["contact"]["folder_name_favorites_list"])
    Logging("3. Input Folder Name Favorites successfully")
    time.sleep(2)
    commond.Wait10s_ClickElement(data["contact"]["click_icon_org"])
    ...
    try:
        ...
        time.sleep(1)
        commond.Wait10s_ClickElement(data["contact"]["select_dept_favorites_contact_gloabl3"])
    except WebDriverException:
        Logging("=>NOT Domain Global3")
        commond.Wait10s_ClickElement(data["contact"]["select_dept_favorites_contact"])
    time.sleep(2)
    commond.Wait10s_ClickElement(data["contact"]["icon_add_user_favorites"])
    time.sleep(2)
    commond.Wait10s_ClickElement(data["contact"]["btn_save_user_favorites"])
    time.sleep(1)
    Logging("5. Select user Favorites successfully")
    commond.Wait10s_InputElement(data["contact"]["txt_description_add_folder"],data["contact"]["content_description_add_folder"])
    Logging("6. Input Description successfully")
    time.sleep(1)
    commond.Wait10s_ClickElement(data["contact"]["btn_save_user_contact_favorites"])
    time.sleep(2)
    commond.Wait10s_ClickElement(data["contact"]["btn_close_delete_folder_favorites"])
    ...
    commond.Wait10s_ClickElement(data["contact"]["select_folder_favorites_delete"])
    Logging("1. Click Folder Favorites Delete successfully")
    commond.Wait10s_ClickElement(data["contact"]["btn_delete_folder_favorites"])
    Logging("2. Click button Delete successfully")
    commond.Wait10s_ClickElement(data["contact"]["btn_ok_folder_favorites"])
