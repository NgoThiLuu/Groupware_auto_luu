...
from luu_function import driver, local, data, Logging, ValidateFailResultAndSystem,TestCase_LogResult,Yellow,Green,Red,commond
...
def board_create_folder(domain_name):
    ...
    commond.Wait10s_ClickElement(data["board"]["list_icon_hide_company_board"])
    Logging("2. Hide list Company Board successfully")
    time.sleep(1)
    Logging("-------------- Write Folder My Board --------------")
    commond.Wait10s_ClickElement(data["board"]["setting_board"])
    Logging("3. Click settings successfully")
    time.sleep(1)
    commond.Wait10s_ClickElement(data["board"]["click_my_board"])
    ...
    commond.Wait10s_InputElement(data["board"]["textbox_description_board"],data["board"]["description_board"])
    time.sleep(1)
    Logging("5. Input Description successfully")
    commond.Wait10s_ClickElement(data["board"]["check_use_comment"])
    Logging("6. Check Use comment successfully")
    commond.Wait10s_ClickElement(data["board"]["turnon_share"])
    commond.Wait10s_ClickElement(data["board"]["click_org_board"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["board"]["select_user_01"])
    commond.Wait10s_ClickElement(data["board"]["icon_add_user"])
    time.sleep(1)
    ...
    time.sleep(1)
    commond.Wait10s_ClickElement(data["board"]["click_button_close_board"])
    Logging("10. Click button Close successfully")
    time.sleep(1)
    driver.execute_script("window.scrollTo(100, 0)")
    time.sleep(1)
    
    commond.scroll_view(data["board"]["show_folder_board"])
...
def board_create_subfolder(domain_name):
    ...
    driver.execute_script("window.scrollTo(100, 0)")
    time.sleep(2)    
    commond.Wait10s_ClickElement(data["board"]["icon_list_parent_board"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["board"]["parent_folder_board"])
    time.sleep(1)
    Logging("11. Select Parent Folder successfully")
    commond.Wait10s_InputElement(data["board"]["input_sub_folder_board"],data["board"]["subfolder_name_board_setting"])
    ...
    time.sleep(2)    
    driver.execute_script("window.scrollTo(100, 0)")
    commond.Wait10s_ClickElement(data["board"]["parent_folder_in_folder_list"])
    time.sleep(2)
    ...
    commond.Wait10s_ClickElement(data["board"]["select_sub_folder"])
    Logging("15. Select subfolder successfully")
    time.sleep(2)
    commond.Wait10s_ClickElement(data["board"]["select_sub_folder_delete"])
    Logging("16. Select icon delete subfolder successfully")
    commond.Wait10s_ClickElement(data["board"]["click_ok_button"])
    commond.Wait10s_ClickElement(data["board"]["click_button_close_board"])
    Logging("17. Delete Sub Folder successfully")
    driver.execute_script("window.scrollTo(100, 0)")
    time.sleep(1) 
    commond.Wait10s_ClickElement(data["board"]["select_folder_parent"])
    time.sleep(1)
...
def board_edit_folder(domain_name):    
    ...
    commond.Wait10s_ClickElement(data["board"]["folder_board_edit"])
    commond.Wait10s_ClickElement(data["board"]["select_folder_type_anonymous"])
    commond.Wait10s_ClickElement(data["board"]["btn_save_folder"])
...
def board_delete_folder(domain_name):
    ...
    time.sleep(3)
    driver.execute_script("window.scrollTo(100, 0)")
    commond.Wait10s_ClickElement(data["board"]["icon_delete_folder_pa"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["board"]["click_ok_button"])
    time.sleep(1)
    commond.Wait10s_ClickElement(data["board"]["click_button_close_board"])
