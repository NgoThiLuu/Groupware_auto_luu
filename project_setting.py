...
def project_create_folder(domain_name):
    ...
    try:
        ...
        now = datetime.now()
        folder_title_project = " Generated by selenium at"  + str(now)
        subject_fodler_project = WebDriverWait(driver, 50).until(EC.presence_of_element_located((By.XPATH, data["project"]["input_folder_mane_project"])))
        subject_fodler_project.send_keys(folder_title_project)
        Commands.Wait10s_ClickElement(data["project"]["button_save_folder_project"])
        time.sleep(1)
        Logging("6. Save folder Project successfully")
        folder_name_create_project = driver.find_element_by_xpath(data["project"]["parent_folder_project"])
...
def project_create_subfolder(domain_name):
    ...
    try:
        ...
        time.sleep(3)
        try:
            sub_folder_name_create_project = driver.find_element_by_xpath(data["project"]["select_subfolder_project_delete"])
            ...
            try:
                ...
                Logging("14. Delete Subfolder Project Fail")
        except WebDriverException:
        ...
        Logging(Red("Not Show Folder Parent Project"))
    time.sleep(1)
...
def project_delete_folder(domain_name):
    try:
        ...
        Logging("14. Delete Folder Project Fail")
...
def project_add_extension_form(domain_name):
    ...
    try:
        ...
        Logging("14. Delete Set extension form Fail")
