...
def project_create_folder(domain_name):
    ...
    #folder_name_project = driver.find_element_by_xpath(data["board"]["input_folder_mane_project"])
    #folder_name_project.send_keys(data["board"]["folder_name_board_setting"])
